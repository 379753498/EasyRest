...
public class JsonUtil {
    ...
    public static String FastObjectToJsonString(Object object) {
        String s = JSONObject.toJSONString(object, SerializerFeature.DisableCircularReferenceDetect, SerializerFeature.WriteDateUseDateFormat);
        return s;
    }
    ...
    public static <T> Result<List<T>> GsonStringToResultList(String JsonString, Class<T> classtype) {
        ...
        list = gson.fromJson(JsonString, new TypeToken<Result<List<T>>>() {
        }.getType());
        return list;
    }
